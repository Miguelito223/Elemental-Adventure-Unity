...
public class PlayerController : MonoBehaviourPunCallbacks
{
    ...
    bool canjump;
    bool isinground;
    public float speed = 100f; // Ajusta la velocidad seg�n sea necesario
    ...
    void Update()
    {
        ...
        // Calcular la direcci�n hacia el mouse (esto ya no afecta al jugador)
        Vector3 mousePosition = Camera.main.ScreenToWorldPoint(Input.mousePosition);
        mousePosition.z = 0; // Asegurarse de que est� en el plano 2D (sin componente z)
        ...
        {
            StartCoroutine(Shoot(direction)); // Pasa la direcci�n hacia el m�todo de disparo
        }
    ...
    private IEnumerator Shoot(Vector2 direction)
    {
        ...
        // Instanciar la bala en la posici�n de disparo
